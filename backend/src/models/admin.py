...
class SaaSPlan(BaseModel):
    ...
    tier: Mapped[str] = mapped_column(String(50), default=PlanTier.FREE.value, nullable=False)
    price_cents: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    billing_cycle: Mapped[str] = mapped_column(String(20), default="monthly", nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)

    max_users: Mapped[int] = mapped_column(Integer, default=5, nullable=False)
    max_resume_processing: Mapped[int] = mapped_column(Integer, default=50, nullable=False)
...
class Subscription(BaseModel):
    ...
    usage_resume_processing: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class OrgFeatureFlagOverride(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("organization_id", "feature_flag_id", name="uix_org_flag_override"),
    )
